...
function requireLib$d() {
  ...
  var _helperPluginUtils = requireLib$e();
...
function requireCreatePlugin() {
  ...
  var _helperPluginUtils = requireLib$e();
  var _core = require$$0;
  var _helperModuleImports = requireLib$f();
  var _helperAnnotateAsPure = requireLib$g();
  const DEFAULT = {
    importSource: "react",
  ...
  function createPlugin$1({ name, development }) {
    return (0, _helperPluginUtils.declare)((_, options) => {
      ...
      } = options;
      {
        ...
        if (RUNTIME_DEFAULT === "classic") {
          if (typeof useSpread !== "boolean") {
            throw new Error(
              "transform-react-jsx currently only accepts a boolean option for useSpread (defaults to false)",
            );
          }
          ...
          Program: {
            enter(path, state) {
              ...
              if (runtime === "classic") {
                ...
                set(state, "id/fragment", () =>
                  _core.types.cloneNode(fragment),
                );
      ...
      function call(pass, name2, args) {
        ...
        if (
          PURE_ANNOTATION != null ? PURE_ANNOTATION : get(pass, "defaultPure")
        )
        ...
        const runtime = get(file, "runtime");
        {
          if (runtime !== "automatic") {
            ...
            if (!useSpread) {
              ...
              props2.forEach((prop, i) => {
                if (_core.types.isSpreadElement(prop)) {
                  if (i > start) {
                    objs.push(
                      _core.types.objectExpression(props2.slice(start, i)),
                    );
                  }
            ...
            if (objs.length === 1) {
              if (
                !(
                  _core.types.isSpreadElement(props2[0]) &&
                  _core.types.isObjectExpression(props2[0].argument)
                )
              ) {
                return objs[0];
              }
...
function requireLib$8() {
  ...
  var helperPluginUtils = requireLib$e();
  ...
  var helperValidatorOption = requireLib$h();
  function _interopDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
  var transformReactJSX__default =
    /* @__PURE__ */ _interopDefault(transformReactJSX);
  var transformReactJSXDevelopment__default = /* @__PURE__ */ _interopDefault(
    transformReactJSXDevelopment,
  );
  var transformReactDisplayName__default = /* @__PURE__ */ _interopDefault(
    transformReactDisplayName,
  );
  var transformReactPure__default =
    /* @__PURE__ */ _interopDefault(transformReactPure);
  ...
  function normalizeOptions(options = {}) {
    {
      ...
      const development =
        options.development == null ? void 0 : !!options.development;
      return {
        development,
        importSource,
        pragma,
...
var babelPresetReact = /*@__PURE__*/ getDefaultExportFromCjs(libExports$a);
...
function require_enum() {
  ...
  var _helperAnnotateAsPure = requireLib$g();
  var _helperSkipTransparentExpressionWrappers = requireLib$i();
  ...
  function transpileEnum(path, t) {
    ...
    switch (parentPath.type) {
      ...
      case "Program": {
        ...
        if (isSeen) {
          const toReplace = parentPath.isExportDeclaration()
            ? parentPath
            : path;
...
`);
  ...
  function translateEnumValues(path, t) {
    var _ENUMS$get;
    const bindingIdentifier = path.scope.getBindingIdentifier(
      path.node.id.name,
    );
    const seen =
...
function requireConstEnum() {
  ...
  const EXPORTED_CONST_ENUMS_IN_NAMESPACE =
    (constEnum.EXPORTED_CONST_ENUMS_IN_NAMESPACE =
  ...
  function transpileConstEnum(path, t) {
    ...
    if (isExported || EXPORTED_CONST_ENUMS_IN_NAMESPACE.has(path.node)) {
      const obj = t.objectExpression(
        entries.map(([name2, value]) =>
          t.objectProperty(
            t.isValidIdentifier(name2)
              ? t.identifier(name2)
              : t.stringLiteral(name2),
            value,
          ),
        ),
      );
    ...
    path.scope.path.traverse({
      ...
      MemberExpression(path2) {
        if (
          !t.isIdentifier(path2.node.object, {
            name,
          })
        )
          return;
...
function requireGlobalTypes() {
  ...
  const GLOBAL_TYPES = (globalTypes.GLOBAL_TYPES =
...
function requireNamespace() {
  ...
  function handleVariableDeclaration(node, name, hub) {
    ...
    if (
      declarations.every((declarator) =>
        _core.types.isIdentifier(declarator.id),
      )
    ) {
  ...
  function handleNested(path, node, parentExport) {
    ...
    {
      namespaceTopLevel = _core.types.isTSModuleBlock(body)
        ? body.body
...
function requireLib$6() {
  ...
  var _helperCreateClassFeaturesPlugin = requireLib$j();
  var _constEnum = requireConstEnum();
  var _enum = require_enum();
  var _globalTypes = requireGlobalTypes();
  ...
  function isInType(path) {
    switch (path.parent.type) {
      ...
      case "TSQualifiedName":
        return (
          path.parentPath.findParent(
            (path2) => path2.type !== "TSQualifiedName",
    ...
    return {
      ...
      visitor: {
          ...
          enter(path, state) {
            ...
            for (let stmt of path.get("body")) {
              if (stmt.isImportDeclaration()) {
                ...
                if (stmt.node.importKind === "type") {
                  for (const specifier of stmt.node.specifiers) {
                    (0, _globalTypes.registerGlobalType)(
                      programScope,
              ...
              if (
                ...
                stmt.isTSImportEqualsDeclaration()
              ) {
                const { id } = stmt.node;
          ...
          if (
            ...
            path.node.specifiers.every(
              (specifier) =>
                ...
                (0, _globalTypes.isGlobalType)(path, specifier.local.name),
            )
          ) {
            path.remove();
            return;
        ...
        ExportSpecifier(path) {
          ...
          if (
            (!parent.source &&
              (0, _globalTypes.isGlobalType)(path, path.node.local.name)) ||
        ...
        ExportDefaultDeclaration(path, state) {
          ...
          if (
            ...
            (0, _globalTypes.isGlobalType)(path, path.node.declaration.name)
          ) {
            path.remove();
            return;
          }
        ...
        [`TSAsExpression${t.tsSatisfiesExpression ? "|TSSatisfiesExpression" : ""}`](
          path,
        ) {
          let { node } = path;
          do {
            ...
            (t.isTSSatisfiesExpression != null &&
...
function requireLib$5() {
  ...
  requireLib$d();
  var transformModulesCommonJS = requireLib$k();
  var helperValidatorOption = requireLib$h();
  function _interopDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
  var transformTypeScript__default =
    /* @__PURE__ */ _interopDefault(transformTypeScript);
  var transformModulesCommonJS__default = /* @__PURE__ */ _interopDefault(
    transformModulesCommonJS,
  );
  const v = new helperValidatorOption.OptionValidator(
...
var babelPresetTypescript = /*@__PURE__*/ getDefaultExportFromCjs(libExports$9);
...
var babelPluginTransformFlowStripTypes =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$8);
...
`);
  ...
  function hasMethodDecorators(body) {
    return body.some((node) => {
      ...
      return (_node$decorators = node.decorators) == null
        ? void 0
            ...
            _core.types.callExpression(
              ...
              [
                ...
                _core.types.arrayExpression(
                  decorators.map((dec) =>
                    _core.types.cloneNode(dec.expression),
                  ),
                ),
                _core.types.objectExpression([
                  _core.types.objectProperty(
...
var babelPluginProposalDecorators =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$7);

var libExports$6 = requireLib$l();
var babelPluginTransformClassProperties =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$6);

var libExports$5 = requireLib$m();
var babelPluginTransformPrivateMethods =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$5);

var libExports$4 = requireLib$n();
var babelPluginTransformPrivatePropertyInObject =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$4);

var libExports$3 = requireLib$o();
var babelPluginTransformNumericSeparator =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$3);
...
function requireIsStatelessComponent() {
  ...
  var VALID_POSSIBLE_STATELESS_COMPONENT_TYPES = [
    "VariableDeclarator",
    "FunctionDeclaration",
  ];
...
function requireRemove() {
  ...
  function remove$1(path, globalOptions, options) {
    ...
    if (mode === "wrap" || mode === "unsafe-wrap") {
      switch (options.type) {
        ...
        case "class static": {
          ...
          if (
            !pathClassDeclaration.isClassExpression() &&
            pathClassDeclaration.node.id
          ) {
            ref = pathClassDeclaration.node.id;
          } else {
            return;
          }
          var node = types.expressionStatement(
    ...
    throw new Error(
      "transform-react-remove-prop-type: unsupported mode ".concat(mode, "."),
    );
  }
  return remove;
}
...
function requireLib() {
  ...
  var _isAnnotatedForRemoval = _interopRequireDefault(
    requireIsAnnotatedForRemoval(),
  );
  var _isStatelessComponent = _interopRequireDefault(
    requireIsStatelessComponent(),
  );
      ...
      visitor: {
        Program: function Program(programPath, state) {
          ...
          if (state.opts.ignoreFilenames) {
            ignoreFilenames = new RegExp(
              state.opts.ignoreFilenames.join("|"),
              "i",
            );
          } else {
          ...
          if (state.opts.classNameMatchers) {
            classNameMatchers = new RegExp(
              state.opts.classNameMatchers.join("|"),
            );
          } else {
          ...
          var globalOptions = {
            ...
            wrapTemplate: function wrapTemplate(_ref) {
              ...
              var _options$as = options.as,
                as =
                  _options$as === void 0 ? "assignmentExpression" : _options$as;
            ...
            libraries: (state.opts.additionalLibraries || []).concat(
              "prop-types",
            ),
            classNameMatchers,
          ...
          if (state.opts.plugins) {
            ...
            var pluginsVisitors = state.opts.plugins.map(function (pluginOpts) {
              ...
              if (typeof pluginOpts !== "string") {
                pluginsState.opts = _objectSpread(
                  {},
                  pluginsState.opts,
                  pluginOpts[1],
                );
          ...
          programPath.traverse({
            ObjectProperty: {
              exit: function exit(path) {
                ...
                var parent = path.findParent(function (currentNode) {
                  ...
                  return (
                    currentNode.get("callee").node.name ===
                      globalOptions.createReactClassName ||
                    (currentNode.get("callee").node.property &&
                      currentNode.get("callee").node.property.name ===
                        "createClass")
                  );
                });
                if (parent) {
            ...
            ClassProperty: function ClassProperty(path) {
              ...
              if (node.key.name === "propTypes") {
                ...
                if (
                  isReactClass(
                    pathClassDeclaration.get("superClass"),
                    scope,
                    globalOptions,
                  )
                ) {
            ...
            AssignmentExpression: function AssignmentExpression(path) {
              ...
              var forceRemoval = (0, _isAnnotatedForRemoval.default)(
                path.node.left,
              );
              if (forceRemoval) {
                path.traverse(collectNestedIdentifiers);
          ...
          var removeNewlyUnusedIdentifiers = {
            VariableDeclarator: function VariableDeclarator(path) {
              ...
              if (
                ["ObjectPattern", "ArrayPattern"].includes(path.node.id.type)
              ) {
                return;
              }
              ...
              var hasRemainingReferencePaths = referencePaths.some(
            ...
            if (globalOptions.mode === "remove") {
              ...
              programPath.traverse({
                ImportDeclaration: function ImportDeclaration(path) {
                  ...
                  var haveUsedSpecifiers = specifiers.some(
                    function (specifier) {
                      var importedIdentifierName = specifier.local.name;
                      var _path$scope$getBindin2 = path.scope.getBinding(
...
var babelPluginTransformReactRemovePropTypes =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$2);

var libExports$1 = requireLib$p();
var babelPluginTransformOptionalChaining =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports$1);

var libExports = requireLib$q();
var babelPluginTransformNullishCoalescingOperator =
  /*@__PURE__*/ getDefaultExportFromCjs(libExports);
